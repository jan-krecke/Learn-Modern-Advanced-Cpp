...
int main() {
  ...
  // cout << p1[0];                            // Error - single object cannot
  // be indexed
  cout << p2[0] << endl;  // Array can be indexed
  // cout << *p2 << endl;                      // Error - array cannot be
  // dereferenced
  // ++p1;                                    // Error - pointer arithmetic not
  // supported
  // ++p2;                                    // Error - pointer arithmetic not
  // supported p1 = p2;                                 // Error - unique_ptr
  // can only be moved unique_ptr<int> p5(p4);                  // Error -
